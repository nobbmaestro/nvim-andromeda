...
function M.setup(opts)
	...
	Group.new("CursorLineNr", colors.cyan, colors.mono_1)
	Group.new("Directory", colors.cyan)
	...
	Group.new("PmenuSel", colors.mono_3, colors.mono_2)
	...
	Group.new("@comment", colors.mono_4)
	Group.new("@conditional", colors.purple)
	...
	Group.new("@define", colors.purple)
	...
	Group.new("@keyword.function", colors.purple, nil, sumStyles({ s.italic }))
	Group.new("@keyword.operator", colors.red)
	Group.new("@keyword.return", colors.purple)
	Group.new("@label", colors.pink)
	...
	Group.new("@preproc", colors.mono_4)
