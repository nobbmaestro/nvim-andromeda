...
function M.setup(opts)
	...
	-- TabLine
	Group.new("TabLine", c.mono_4, c.mono_2)
	Group.new("TabLineFill", nil, c.mono_2)
	Group.new("TabLineSel", c.mono_5, nil)
	...
	Group.new("Character", c.mono_4)
	Group.new("Comment", c.mono_4, nil, sumStyles({ s.it }))
	Group.new("Conceal", c.mono_4)
	...
	Group.new("@preproc", c.mono_4, nil, sumStyles({ s.it }))
	Group.new("@property", c.pink)
	Group.new("@punctuation", c.mono_5)
	Group.new("@punctuation.bracket", c.yellow)
	Group.new("@punctuation.delimiter", c.mono_5)
	...
	Group.new("@text.literal", c.mono_4)
	Group.new("@text.reference", c.hot_pink)
	Group.new("@text.title", c.hot_pink)
	Group.new("@text.todo", c.hot_pink)
	Group.new("@text.underline", c.green)
	Group.new("@text.uri", c.hot_pink)
	...
	Group.new("GitBlameMsg", g.DiffText, g.DiffText, sumStyles({ s.it }))
end
