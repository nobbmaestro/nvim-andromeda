...
M.theme = {
    normal = {
        ...
        b = { fg = c.green, bg = c.mono_2 },
        c = { fg = c.mono_5, bg = c.mono_1 },
        x = { fg = c.mono_5, bg = c.mono_1 },
        y = { fg = c.mono_5, bg = c.mono_1 },
        z = { fg = c.mono_6, bg = c.mono_1 },
    },
    insert = {
    ...
    terminal = {
        ...
        x = { fg = c.mono_5, bg = c.mono_1 },
        y = { fg = c.mono_5, bg = c.mono_1 },
        z = { fg = c.hot_pink, bg = c.mono_1 },
    },
    inactive = {
        a = { fg = c.background, bg = c.background },
        b = { fg = c.background, bg = c.background },
        c = { fg = c.background, bg = c.background },
    },
}
